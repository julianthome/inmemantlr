 ...
 */
public class MemoryTokenFile extends MemoryFile implements Serializable {
     ...
     */
    public MemoryTokenFile(String name, String src) {
        super(URI.create("file:///" + name + ".tokens"), Kind.OTHER);
        this.src = src;
        cname = name;
    }
